...
define("TOKEN", "wemall");
$wechatObj = new wechatCallbackapiTest($weixin['title'] , 'http://'.$_SERVER['HTTP_HOST'].'/Public/Uploads/'.$weixin['picurl'] , $weixin['description'] , 'http://'.$_SERVER['HTTP_HOST'].'/index.php/App/Index/index?uid=');
