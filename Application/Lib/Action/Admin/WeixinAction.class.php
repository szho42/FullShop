...
class WeixinAction extends PublicAction {
	...
	public function index() {
		...
		$wechatObj = new wechatCallbackapiTest ( $result[0] ['title'], APP_SITE.'/Public/Uploads/' . $result[0]['picurl'],  $result[0]['description'], APP_SITE.'/index.php/App/Index/index?uid=' );
